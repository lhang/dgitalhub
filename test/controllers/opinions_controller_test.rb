...
class OpinionsControllerTest < ActionController::TestCase
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post :create, opinion: { content: @opinion.content, parent_opinion_id: @opinion.parent_opinion_id, user_id: @opinion.user_id }
    end
  ...
  test "should update opinion" do
    patch :update, id: @opinion, opinion: { content: @opinion.content, parent_opinion_id: @opinion.parent_opinion_id, user_id: @opinion.user_id }
    assert_redirected_to opinion_path(assigns(:opinion))
  end
